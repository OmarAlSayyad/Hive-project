...
<li class="menu-header small text-uppercase">
  ...
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Authantications /</span> Add Admin</h4>
      ...
      <ul class="nav nav-pills flex-column flex-md-row mb-3">
        ...
        <li class="nav-item">
          <a class="nav-link" href="pages--notifications.html">     /////////
            <i class="bx bx-bell me-1">Accept Company reqest</i> 
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="pages-account-settings-connections.html">
            <i class="bx bx-link-alt me-1"></i> Bann users
          </a>
        </li>
      </ul>
      <div class="card mb-4">
          ...
          <form id="formAccountSettings" method="POST" action="{{ route('admin.store') }}">
            ...
            <div class="row">
              ...
              <div class="mb-3 col-md-12">
                <label class="form-label">Admin Authorities:</label>
                <div>
                  <div class="form-check">
                    ...
                    />
                    <label class="form-check-label" for="can_add_admins">Can Add Other Admins</label>
                  </div>
                  <div class="form-check">
                    <input
                      class="form-check-input"
                      type="checkbox"
                      id="can_accept_companies"
                      name="permissions[]"
                      value="can_accept_companies"
                    />
                    <label class="form-check-label" for="can_accept_companies">Can Accept Companies</label>
                  </div>
                  <div class="form-check">
                    <input
                      class="form-check-input"
