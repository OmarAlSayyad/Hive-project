                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                          <span class="fw-semibold d-block">Hossin Ali</span>
                  ...
                  <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <span class="fw-semibold d-block mb-1">New Users</span>
                        <h3 class="card-title mb-2">{{$newUsers}}</h3>
                        <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> {{$growthPercentage}}</small>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> {{$growthPercentageJ}}</small>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card">
                  <div class="row row-bordered g-0">
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="text-center fw-semibold pt-3 mb-2">user balance</div>
                      ...
                      <div class="d-flex px-xxl-4 px-lg-2 p-4 gap-xxl-3 gap-lg-1 gap-3 justify-content-between">
                        ...
                        <div class="d-flex">
                          ...
                          <div class="d-flex flex-column">
                            <small>seekers number</small>
                            <h6 class="mb-0">{{$seekers}}</h6>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                          <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                            <div class="card-title">
                              <h5 class="text-nowrap mb-2">Succsecfull Applications</h5>
                              <span class="badge bg-label-warning rounded-pill">Year 2024</span>
                            </div>
                            <div class="mt-sm-auto">
                              <small class="text-success text-nowrap fw-semibold"><i class="bx bx-chevron-up"></i> {{$plus}}</small>
                              <h3 class="mb-0">{{$sucess}}</h3>
                            </div>
                          </div>
                ...
                <div class="card h-100">
                  <div class="card-header d-flex align-items-center justify-content-between pb-0">
                    <div class="card-title mb-0">
                      <h5 class="m-0 me-2">catgory Statistics</h5>
                      <small class="text-muted">5 total catgories</small>
                    </div>
                    <div class="dropdown">
                    ...
                    <ul class="p-0 m-0">
                      <li class="d-flex mb-4 pb-1">
                        ...
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                          <div class="me-2">
                            <h6 class="mb-0">IT</h6>
                            <small class="text-muted">ITE, UI/UX, Networking</small>
                          </div>
                      ...
                      <li class="d-flex mb-4 pb-1">
                        ...
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                          <div class="me-2">
                            <h6 class="mb-0">Handy Work</h6>
                            <small class="text-muted">Black smith,Wood work,Repaier</small>
                          </div>
                          <div class="user-progress">
                      ...
                      <li class="d-flex mb-4 pb-1">
                        ...
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                          <div class="me-2">
                            ...
                            <small class="text-muted">Secartary, Accountant</small>
                          </div>
                          <div class="user-progress">
                    ...
                    <div class="tab-content p-0">
                      <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                        ...
                        <div class="d-flex justify-content-center pt-4 gap-2">
                          ...
                          <div>
                            <p class="mb-n1 mt-1">transactions This Week</p>
                            <small class="text-muted">$37785</small>
                          </div>
                        </div>
                      </div>
                    </div>
